...
![[Accelerate: Building and Scaling High-Performing Technology Organizations](https://www.goodreads.com/book/show/35747076-accelerate) by Nicole Forsgren, Jez Humble, Gene Kim](accelerate-book.jpg){.column-margin}

![The kind of gate I'm talking about.](https://upload.wikimedia.org/wikipedia/commons/b/bd/Farm_gate_-_geograph.org.uk_-_538713.jpg){.column-margin}
...
In the jargon, this is *predictive inference*, and it is the kind of inference that _Accelerate_ describes[^chapter12].
...
The unfortunate situation is that predictive inference explains nothing. It may validate a hypothesis based on a theory but the scientific literature is littered with such validations that later turned out to be false[^phack]. 
...
[^chapter12]: In chapter 12 they go into some detail.
[^phack]: Try [this website](https://projects.fivethirtyeight.com/p-hacking/) to demonstrate your political point.
