...
image: cd-dependency-graph.svg
date: "2020-02-03 08:25:00 +01:00"
tags:
- continuous delivery
---

[DORA](https://cloud.google.com/devops/#technical) recommends strengthening a core set of [**technical practices**](https://cloud.google.com/devops#technical)[^technical-practices] to "drive"[^drive] Continuous Delivery, which in turn "drives" business performance.

They clearly have internal relationships and, like XP[^xp-web], there is a dependency graph of interlocking practices. For example, it's difficult to image trunk-based development without some kind of version control. I was curious what it looked like so I gave it a first stab.

![CD Dependency Web](cd-dependency-graph.svg)
...
[^technical-practices]: Go to the [website](https://www.devops-research.com/research.html) and click on the "Technical Practices" node. Alternatively take a look at their book Accelerate which lays all of this out in detail.
[^drive]: Causal inference is a stated assumption. It's debatable whether this is the case but that's for another time.
[^xp-web]: See, for example, [Extreme Programming Annealed](https://vanderburg.org/writing/xpannealed.pdf) - Glenn Vanderburg
[^tuning]: DB level scaling in the presence of slow queries often goes under the euphemism of "tuning".
