...
title: Teal Organisation in the Methodist Tradition
...
My parents are practising Methodists, just as their parents before them, and, although I stopped attending church regularly in my teens, my upbringing was steeped in Methodist traditions. Reading![[Reinventing Organizations](https://www.goodreads.com/book/show/20787425-reinventing-organizations) by Frederic Laloux](reinventing-organizations-book.jpg){.column-margin} about the traits of different organisational patterns in the book "Reinventing Organizations", although the author considers religious organisations to be generally Amber-Conservative, it's interesting to see the similarities between the Teal-Evolutionary approach and some of the practices of the methodist church, especially at local level.
...
When problems present themselves such as special efforts for charity, unexpected expenditure for maintenance[^operational-risk], etc. then the local churches may ask the circuit for help or guidance. In turn, the circuit may ask the district for help, and so on[^queen]. Nonetheless, it remains the responsibility of the local church itself to ultimately solve the problem, even if that means making some very hard decisions.

It must be understood that new ideas must be "sold" to other members of the community for consensus to be reached. It is also necessary to accept (and be able to accept) the consensus even when it may not suit you personally[^acquiesce].
...
[^operational-risk]: Known as '[Operational Risk](https://en.wikipedia.org/wiki/Operational_risk)' in the banking sector.
[^queen]: Not sure where that ends, probably with the Queen or something.
[^acquiesce]: Note to self: active acquiescence
