---
categories: [software-engineering, organisations]
...
These are notes taken from my introductory lightning talk at [Codurance](https://codurance.com) which is why it's a bit rambly. I wanted to talk about what software quality means to me.
...
The best cricketers are usually those with the highest number of runs scored or the number of wickets taken. It is easy to measure *goodness* when metrics like this are available[^metrics] but it also means intangibles, like teaching ability or strategic awareness, are not properly valued.
...
Pirsig's initial perception of Quality changes over time taking into account the *rational* way he approaches the maintenance of his own motorcycle compared to the attitude[^attitude] of his friend. His conclusion, as in many things in this life, is that we should strive to combine both perspectives. Quality itself is a judgement making sense only in a given context[^quality-is-a-quality]![](qualityuml.png){.column-margin}.

So what does this mean for the software professional? It depends. What type of professional do you want to be: the politician or the cricketer? How do you approach your work, like Pirsig's Harley or Sutherland's BMW?[^functional]
...
[^metrics]: This is why we look for metrics to help us judge the *quality* of work by salesmen, marketeers, factory workers, etc. Some managers might try to measure programmers in a similar way using, for example LOC.
[^attitude]: Pirsig calls it *romantic* but it could also be seen as *functional* or *pragmatic*
[^quality-is-a-quality]: "Quality is a quality"
[^functional]: Most businesses (and managers) treat software as purely functional and expect a BMW. The worst developers aim for BMW but provide an rickety moped. Other developers provide a Harley Davidson which does not fit with the rest of the mopeds in the garage
