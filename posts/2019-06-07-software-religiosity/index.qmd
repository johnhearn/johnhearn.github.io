...
Between sessions we socialise and "network" with the community, discuss the latest news, share our experiences and look for new opportunities. Again, it seems like the community aspect of these conferences are as important or even more important than the content[^talking].



Interestingly these same communities partake in *religious wars* and split into factions.

To be part of a community it is not necessary to believe all of its espoused values. In fact that would be impossible by the flaw of averages[^average-pilots]. What *is* necessary is to be able to *accept those values* or be able to *challenge them on the community's own terms*.
...
[^church]: Methodists, at least in this community not sure if it's universal, go to chapel rather than church. A chapel tends to be more scantly decorated and understated than a church. People from the Anglican community were referred to respectfully as “church people”.
[^talking]: I'm not sure what the psychological motivation is for some of us to want to speak in front of crowds but, at least for me, it seems that it is not solely commercial.
[^average-pilots]: See this interesting article about [when U.S. air force discovered this flaw](https://www.thestar.com/news/insight/2016/01/16/when-us-air-force-discovered-the-flaw-of-averages.html).
