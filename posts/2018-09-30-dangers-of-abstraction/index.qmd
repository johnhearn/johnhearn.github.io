---
categories: [modelling, philosophy, software-engineering]
...
Highly abstract concepts depend on other concepts which in turn depend on others and so it goes on. Turtles all the way down[^deep-learning]. 
...
[^deep-learning]: It's interesting to compare concepts with features extracted by deep learning algorithms. These algorithms are often criticised as being opaque but how many of us really know _why_ we think what we think?
[^more-concepts]: and _right_ and _wrong_ and _justice_ and _value_ and _religion_ and _love_ and ...
[^open-plan-offices]: The [joy](https://m.signalvnoise.com/the-open-plan-office-is-a-terrible-horrible-no-good-very-bad-idea-42bd9cd294e3) of open plan offices.
[^continuous]: *continual* would have been a much better word in this context but hey-ho
[^integration-tests]: As so often, Martin Fowler was ahead of us: “_And there is a large population of software developers for whom “integration test” only means “broad integration tests”, leading to plenty of confusion when they run into people who use the narrow approach._”
