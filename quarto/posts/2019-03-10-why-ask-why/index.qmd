...
2. The second, “*para qué?*”, is about what is expected to be achieved by doing something - as in “*Why did you throw the cat out of the window?*”[No cats were harmed in the making of this post.]{.column-margin}. It's about the purpose or intention of an action, an active voice.
...
If the reason you work where you do is because the office is close to your house then that's a passive reason. On the other hand if it's because it's a job which fits with your interests and goals then that is an active reason[^wardly]. 
