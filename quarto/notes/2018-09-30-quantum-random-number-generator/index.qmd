...
[One thing to understand is that, as things stand, quantum computers are not particularly useful.]{.smallcaps} The limited number of quantum bits we have to work with is so limited that classical computers, with over half a century of exponential improvements behind them, beat quantum algorithms at every task. 
...
![Random number circuit](3-bit-rng.png){width="320px"}
