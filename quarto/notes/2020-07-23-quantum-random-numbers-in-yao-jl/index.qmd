...
The first example I use for understanding quantum computing concepts is the [Quantum Random Number Generator](../2018-09-30-quantum-random-number-generator/). It's also the simplest example possible. Let's see what it looks like [Yao.jl].
...
![Uniformly distributed random numbers.](uniform-distribution.png){width="200px"}
