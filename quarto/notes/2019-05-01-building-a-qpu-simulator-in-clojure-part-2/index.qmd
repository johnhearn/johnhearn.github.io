...
In the [last post](../2019-01-25-building-a-qpu-simulator-in-clojure-part-1/) we simulated a single qubit and a couple of simple gates. Using those gates we could implement a trivial coin toss function and an 8-sided die. Now we'll go on to incorporate the Neanderthal library before implementing more gates with complex matrices.
