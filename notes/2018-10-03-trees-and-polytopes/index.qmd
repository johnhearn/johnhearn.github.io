...
This structure is isomorphic to the family of [cross-polytope](https://en.wikipedia.org/wiki/Cross-polytope)s[^polyhedral-representation]. Here is the skeletal graph of the 4 element cross-polytope (a square).
...
[^polyhedral-representation]: [Edit: this is not a new idea. See [this library](https://polyhedral.info/) which leverages polyhedral representations for algorithm compilation. 
