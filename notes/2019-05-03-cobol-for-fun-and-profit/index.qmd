...
![COBOL in VS Code](vscode-cobol.png)
...
So, if we can take COBOL and compile it to native binaries then couldn't we take, for example, existing CICS transactions written for standard mainframes and deploy them as services, for example, in a [serverless](../../posts/2018-12-29-serverless-is-the-new-mainframe/) environment?
