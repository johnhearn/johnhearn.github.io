...
One way to learn a new language is to compare it to one you already know. Here I'm taking a program written in Clojure[^credit] and comparing it with similar code in Kotlin. The objective is two-fold, firstly to help me learn Clojure and secondly to see the similarities and differences between these two languages. In the following I'll assume some minimum knowledge of both.
...
In Kotlin to do the same is slightly more verbose[^less-verbose-than-java]. We can use `Pair`s (tuples) and `typealias`es here to improve the readability.
...
[^credit]: The code is taken from my colleague [Richard Wild](https://codurance.com/publications/author/richard-wild/)'s excellent series of articles on [Functional Programming](https://codurance.com/2018/11/02/the-functional-style-part-6/).
[^less-verbose-than-java]: But not as verbose a Java :)
